...
const GetInTouch = () => {
  ...
  const contactInfo = [
    {
      icon: Mail,
      title: "Email Us",
      detail: "sahasratechnologysolutions@gmail.com",
      description: "General inquiries & AI project discussions",
      action: "mailto:sahasratechnologysolutions@gmail.com",
    },
    {
      icon: Phone,
      title: "Call Us",
  ...
  const offices = [
    {
      name: "Sahasra HQ",
      address: "Raja street, Atmakur, Nandyal - 518422",
      phone: "+91 9908564639",
      email: "sahasratechnologysolutions@gmail.com",
  ...
  try {
    // Optional: simulate a network delay
            ...
            <motion.div {...fadeInUp}>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Button
                  ...
                  onClick={() => window.open("tel:9908564639")}
                >
